...
export class TodoService {
    ...
    // get back an array of portfolio and we want to extract it in a way that it fits the t_odo object we are using on
    // the frontend. We get an array of custom type portfolio that match the model that we can directly
